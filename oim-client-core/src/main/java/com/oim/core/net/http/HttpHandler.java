...
public class HttpHandler {
	...
	public void execute(String http,Request data, DataBackAction dataBackAction) {
		try {
			...
			RequestMessage rm = data.getRequestMessage();
			String json = OnlyJsonUtil.objectToJson(rm);
