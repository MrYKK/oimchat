 ...
 * @author XiaHui
 */
public class OnlyPopupOverFrame extends OnlyFrame {
	...
	private void initEvent() {
		button.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				po.show(OnlyPopupOverFrame.this, OnlyPopupOverFrame.this.getX(), OnlyPopupOverFrame.this.getY());
